	...
	<?php
		...
		<form method="post" action="">
			<?php echo $error; ?>
			<input name="name" placeholder="Name" type="text" id="name" size="30" value="<?php echo $name; ?>" />
			<input name="email" placeholder="Email" type="text" id="email" size="30" value="<?php echo $email; ?>" />
			<input type="phone" placeholder="Phone" class="text-input" name="phone" />
			<textarea name="comments" placeholder="Comments" cols="40" rows="6" id="comments"><?php echo $comments; ?></textarea>
			
			<input type="radio" name="have" value="I have a brand" class="radio" checked/><span>I have a brand</span><br>
			<input type="radio" name="have" value="I'm an influencer" class="radio" /><span>I'm an influencer</span><br>

			<button name="contactus" type="submit" class="submit btn blue" id="contactus">Send</button>
